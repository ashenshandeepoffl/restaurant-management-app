    ...
    <footer className="bg-gray-900 text-white py-12 mt-16">
      <div className="container mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="text-gray-400 mt-2">Innovating for a smarter future.</p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="mailto:info@axioralabs.com" className="hover:text-yellow-400 transition">
                info@axioralabs.com
              </a>
            </li>
            <li>
              <a href="https://goo.gl/maps/XnYb5K5wzQv" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 transition">
        ...
        {/* Working Hours */}
        <div>
          <h3 className="text-lg font-semibold mb-4 text-yellow-400">Working Hours</h3>
      ...
      <div className="border-t border-gray-700 mt-12 pt-6 text-center">
        <p className="text-gray-400">&copy; {new Date().getFullYear()} Axiora Labs. All Rights Reserved.</p>
      </div>
    </footer>
  );
}
